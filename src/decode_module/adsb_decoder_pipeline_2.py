...
Usage:
    ...
    python3 -m src.decode_module.adsb_decoder_pipeline_2 --file src/decode_module/iq_samples_20251019_172049_619.bin .csv

    # File mode — no output save
    python3 -m src.decode_module.adsb_decoder_pipeline_2 --file src/decode_module/iq_samples_20251019_172049_619.bin

    # Live FIFO mode — no output save (launcher handles this normally)
    python3 -m src.decode_module.adsb_decoder_pipeline_2

    # Live FIFO mode — save CSV
    python3 -m src.decode_module.adsb_decoder_pipeline_2 .csv
"""
